...
This sample post shows you two different ways to use SQL in an R Markdown document. The post includes a table of contents and code highlighting. The post content covers inserting and executing pure SQL code chunks and using R to execute SQL queries.
